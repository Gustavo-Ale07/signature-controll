  ...
  const onSubmit = async (data: ItemForm) => {
    try {
      ...
      await itemService.update(id, {
        ...
        value: Number.isNaN(data.value) ? undefined : data.value,
        billingDay: Number.isNaN(data.billingDay) ? undefined : data.billingDay,
  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Editar Item</h1>
